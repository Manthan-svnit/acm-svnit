...
function Preloader({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Progress bar */}
      <motion.div className="absolute bottom-12 w-48 h-0.5 bg-white/10 rounded-full overflow-hidden">
        <motion.div
...
function AwardsCarousel() {
  ...
  return (
    <div className="relative w-full max-w-3xl mx-auto">
      ...
      <div className="relative overflow-hidden rounded-2xl min-h-[280px] flex items-center">
        <AnimatePresence mode="wait" custom={direction}>
          <motion.div
            ...
            className={`absolute inset-0 bg-gradient-to-br ${award.bg} border border-white/10 rounded-2xl p-10 flex flex-col items-center text-center justify-center`}
          >
            <motion.div
      ...
      <button
        onClick={() => paginate(-1)}
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-5 bg-white/10 hover:bg-[#0055A2] text-white p-2 rounded-full transition-colors duration-200 z-10"
      ...
      <button
        onClick={() => paginate(1)}
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-5 bg-white/10 hover:bg-[#0055A2] text-white p-2 rounded-full transition-colors duration-200 z-10"
...
function StatCard({
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center text-center p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-[#0055A2]/60 transition-all duration-300 hover:bg-[#0055A2]/10 group"
    >
...
function FeatureCard({
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="group block p-8 rounded-2xl bg-[#111111] border border-white/10 hover:border-[#0055A2] transition-all duration-300 text-center"
      >
  ...
  return (
    <div className="bg-[#0d1117] text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center -mt-20 overflow-hidden">
        ...
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/55 to-[#0d1117]" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0055A2]/20 via-transparent to-transparent" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-10 py-4 rounded-full text-white font-bold text-lg transition-all duration-300"
                style={{
